<x-layout title="Create Post">
    ...
    <form method="POST" action="/blog" style="margin: 40px;">
        @csrf
        <div class="space-y-12">
            <!-- تم حذف border-b و pb-12 من هنا -->
            <div>
                <h1 class="text-base/7 font-bold text-gray-900">Create New Post</h1>
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            <textarea
                                ...
                                name="content"
                                rows="3"
                                class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 {{ $errors->has('content') ? 'outline-red-500 focus:outline-red-600' : 'outline-gray-300 focus:outline-indigo-600' }} sm:text-sm/6">{{ old('content') }}</textarea>
                        </div>
